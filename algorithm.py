...
def algorithm1(GG):
    ...
    while not nx.is_empty(G):
        ...
        #    node_to_delete = G.index(delta_max)
        for u in G.nodes:
    ...
    write_in_file(GG, 'From Algorithm1')

    #print(list(GG.edges()))
    #print(S1)
    #print(GG.size())
#print(nx.find_cycle(GG, orientation='original'))
